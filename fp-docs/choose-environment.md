...
> - You must not delete Forms Pro data from Common Data Service. If you delete any data from Common Data Service, it is not synchronized with Forms Pro services. 
