...
- **Custom score**: Custom score is a metric used to measure your respondent's overall satisfaction level by using survey scores. More information: [Survey scoring](survey-scoring.md)
