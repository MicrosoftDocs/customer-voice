...
- **Add respondents as Contacts**: Specify whether the respondent should be added as a contact in Common Data Service.
    ...
    By default, this setting is turned on, and each respondent is added as a contact in Common Data Service. This only works with surveys sent through [email](send-survey-email.md) or [survey invitation](create-survey-invite.md).
